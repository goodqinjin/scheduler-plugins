...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*NodeTemperatureArgs)(nil), (*config.NodeTemperatureArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta2_NodeTemperatureArgs_To_config_NodeTemperatureArgs(a.(*NodeTemperatureArgs), b.(*config.NodeTemperatureArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.NodeTemperatureArgs)(nil), (*NodeTemperatureArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_NodeTemperatureArgs_To_v1beta2_NodeTemperatureArgs(a.(*config.NodeTemperatureArgs), b.(*NodeTemperatureArgs), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta2_NodeResourceTopologyMatchArgs_To_config_NodeResourceTopologyMatchArgs(in *NodeResourceTopologyMatchArgs, out *config.NodeResourceTopologyMatchArgs, s conversion.Scope) error {
	...
	if err := Convert_v1beta2_ScoringStrategy_To_config_ScoringStrategy(&in.ScoringStrategy, &out.ScoringStrategy, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_config_NodeResourceTopologyMatchArgs_To_v1beta2_NodeResourceTopologyMatchArgs(in *config.NodeResourceTopologyMatchArgs, out *NodeResourceTopologyMatchArgs, s conversion.Scope) error {
	...
	if err := Convert_config_ScoringStrategy_To_v1beta2_ScoringStrategy(&in.ScoringStrategy, &out.ScoringStrategy, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_v1beta2_NodeTemperatureArgs_To_config_NodeTemperatureArgs(in *NodeTemperatureArgs, out *config.NodeTemperatureArgs, s conversion.Scope) error {
...
// Convert_v1beta2_NodeTemperatureArgs_To_config_NodeTemperatureArgs is an autogenerated conversion function.
func Convert_v1beta2_NodeTemperatureArgs_To_config_NodeTemperatureArgs(in *NodeTemperatureArgs, out *config.NodeTemperatureArgs, s conversion.Scope) error {
	return autoConvert_v1beta2_NodeTemperatureArgs_To_config_NodeTemperatureArgs(in, out, s)
}

func autoConvert_config_NodeTemperatureArgs_To_v1beta2_NodeTemperatureArgs(in *config.NodeTemperatureArgs, out *NodeTemperatureArgs, s conversion.Scope) error {
...
// Convert_config_NodeTemperatureArgs_To_v1beta2_NodeTemperatureArgs is an autogenerated conversion function.
func Convert_config_NodeTemperatureArgs_To_v1beta2_NodeTemperatureArgs(in *config.NodeTemperatureArgs, out *NodeTemperatureArgs, s conversion.Scope) error {
	return autoConvert_config_NodeTemperatureArgs_To_v1beta2_NodeTemperatureArgs(in, out, s)
}
