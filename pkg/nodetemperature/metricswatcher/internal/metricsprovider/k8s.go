...
func NewMetricsServerClient() (metricswatcher.MetricsProviderClient, error) {
...
func (m metricsServerClient) Name() string {
	return metricswatcher.K8sClientName
}

func (m metricsServerClient) FetchHostMetrics(host string, window *metricswatcher.Window) ([]metricswatcher.Metric, error) {
	...
	var cpuFetchedMetric metricswatcher.Metric
	var memFetchedMetric metricswatcher.Metric
	...
	cpuFetchedMetric.Type = metricswatcher.CPU
	cpuFetchedMetric.Operator = metricswatcher.Latest
	...
	memFetchedMetric.Type = metricswatcher.Memory
	memFetchedMetric.Operator = metricswatcher.Latest
	metrics = append(metrics, memFetchedMetric)
	return metrics, nil
}

func (m metricsServerClient) FetchAllHostsMetrics(window *metricswatcher.Window) (map[string][]metricswatcher.Metric, error) {
