...
var _ = framework.PreFilterPlugin(&NodeTemperature{})
...
func (nt *NodeTemperature) PreFilter(ctx context.Context, state *framework.CycleState, p *v1.Pod) *framework.Status {
	klog.Info("[NodeTemperature] starting pre-filtering...")
	return framework.NewStatus(framework.Success, "")
}

// PreFilterExtensions returns a PreFilterExtensions interface if the plugin implements one.
func (nt *NodeTemperature) PreFilterExtensions() framework.PreFilterExtensions {
	return nil
}
